...
const books: readonly Book[] = [
  {
    ...
    sizes: "(min-width: 68rem) 108px, 78px",
    className:
      "w-[78px] desktop:w-[108px] -rotate-[7deg] rounded-sm bg-cover-clay shadow-xl hover:-translate-y-2.5 hover:shadow-2xl",
  },
  {
    src: fellowshipOfTheRing,
    alt: "The Fellowship of the Ring book cover",
    sizes: "(min-width: 68rem) 128px, 92px",
    className:
      "w-[92px] desktop:w-32 -translate-y-[18px] rounded-lg bg-cover-sage shadow-2xl hover:-translate-y-[28px]",
  },
  {
    ...
    sizes: "(min-width: 68rem) 108px, 78px",
    className:
      "w-[78px] desktop:w-[108px] rotate-[7deg] rounded-sm bg-cover-linen shadow-xl hover:-translate-y-2.5 hover:shadow-2xl",
  },
];
